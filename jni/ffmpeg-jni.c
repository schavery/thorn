...
JNIEXPORT void JNICALL Java_edu_santarosa_szgcat_thorn_TestJni_naInit(JNIEnv *pEnv, jobject pObj, jstring pFileName) {
	int l_mbH, l_mbW;
...
//JNIEXPORT jstring JNICALL Java_edu_santarosa_szgcat_thorn_TestJni_naGetVideoCodecName(JNIEnv *pEnv, jobject pObj) {
